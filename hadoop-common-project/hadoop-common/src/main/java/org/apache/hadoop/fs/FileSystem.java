...
//Hadoop提供了一个抽象的文件系统模型FileSystem，抽象文件系统的类文件都在org.apache.hadoop.fs包中。
//这些类主要完成文件系统模型的建立，定义对文件系统中的文件所进行的抽象操作
...
public abstract class FileSystem extends Configured
  ...
  //hadoop所使用的默认的文件系统的配置项  fs.default.name
  ...
  /** The key this instance is stored under in the cache.  缓存的key */
  private Cache.Key key;

  /** Recording statistics per a FileSystem class.  记录每个文件系统的统计信息的映射*/
 ...
 /**
  ...
  /** Caching FileSystem objects. 内部类 */
  static class Cache {
